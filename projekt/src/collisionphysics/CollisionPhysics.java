...
public class CollisionPhysics {
   ...
   public static void pointIntersectsMovingPoint(
         float p1X, float p1Y, float p1SpeedX, float p1SpeedY, float p1Radius, float p1Mass,
         float p2X, float p2Y, float p2SpeedX, float p2SpeedY, float p2Radius, float p2Mass,
      ...
      if (t > 0 && t <= timeLimit) {
         ...
         pointIntersectsMovingPointResponse(
               p1X, p1Y, p1SpeedX, p1SpeedY, p1Radius, p1Mass,
               p2X, p2Y, p2SpeedX, p2SpeedY, p2Radius, p2Mass,
